...
# Source: Message.ORiN3.Provider/V1/orin3_job.proto for package 'Message.ORiN3.Provider.V1.AutoGenerated.Job'

require 'grpc'
require_relative './../../Message.ORiN3.Provider/V1/orin3_job_pb'
